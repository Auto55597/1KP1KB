...
<head>
    ...
    <meta name="google-site-verification" content="RS6TpVLLV5g-UKrvaPKZu7KkNL72dJxblzBxSvZUynU" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AI Job Salary Directory - 1KP1KB</title>
    <style>
        ...
        .job-link {{ display: block; padding: 15px; border-bottom: 1px solid #eee; text-decoration: none; color: #444; transition: 0.2s; }}
        .job-link:hover {{ background: #f9f9f9; color: #10b981; padding-left: 20px; }}
        footer {{ margin-top: 50px; padding-top: 20px; border-top: 1px solid #ddd; text-align: center; font-size: 14px; color: #666; }}
        footer a {{ color: #10b981; text-decoration: none; margin: 0 10px; }}
        footer a:hover {{ text-decoration: underline; }}
    </style>
</head>
<body>
    <h1>AI Job Salary Directory (Batch 1)</h1>
    <p>Explore high-paying AI opportunities and salary trends globally.</p>
    ...
    <footer>
        <p>&copy; 2026 1KP1KB Project. All rights reserved.</p>
